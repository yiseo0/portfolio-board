      ...
      <Wrapper>
         ...
         <Form method="POST" onSubmit={handleSubmit(onSubmit)}>
            <WriteBox row="2">
               ...
               <Write type="text" {...register("writer", { required: "이름을 입력해주세요." })} />
            ...
            <WriteBox>
               ...
               <WriteContent type="text" placeholder="내용을 작성해주세요." {...register("contents", { required: "내용을 작성해주세요." })} />
               <Error>{errors.contents?.message}</Error>
            </WriteBox>
            <WriteBox>
               <Label htmlFor="">주소</Label>
               <WriteAddress type="text" placeholder="07250" {...register("zipCode")} />
            ...
            <WriteBox>
               ...
               <Write type="text" placeholder="링크를 복사해주세요." {...register("youtube")} />
            </WriteBox>
            <WriteBox>
